...
# Default 500 token/hari
NEXT_PUBLIC_BAKERY_DAILY_TOKEN_LIMIT=500
# Optional: limit assignment token per staff per hari (default ikut limit harian global)
NEXT_PUBLIC_BAKERY_STAFF_DAILY_TOKEN_LIMIT=500
