...
const examplePayload = {
  ...
  imageUrl: 'https://res.cloudinary.com/demo/image/upload/orders/generated/template-123.jpg',
  imageUrls: [
    'data:image/png;base64,AAAA...',
    'https://uploads.example.com/user-uploads/order-456.jpg',
  ],
  referenceImages: [
    { url: 'https://uploads.example.com/user-uploads/ref-1.jpg', label: 'Design 1' },
  ],
};
...
function selectOriginalImage(order) {
  ...
  const originalImageUrl = sourceImageCandidates.find((u) => /^https?:\/\//i.test(String(u)));
...
console.log('Chosen original image (should be user-upload HTTP):', selection.originalImageUrl);
